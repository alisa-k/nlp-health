...
df = pd.read_csv('NOTEEVENTS.csv', nrows = 10)
...
### create the word cloud HERE

#must convert your words list to a frequency dictionary

#freqDict2 = wordListToFreqDict(...)

#wordcloud2 = ... #see above
...
################################################################
## Part C: tfidf 
# this will compare the words in each note to the words in all notes 
